...
if (_function == "INIT") then {
	...
	{
		["fnf_ocap_handleMarker", ["CREATED", _x call BIS_fnc_markerToString, _x, objNull]] call CBA_fnc_serverEvent;
...
_pos
			...
			if (_sideOfMarker isEqualTo 4 || (["Projectile#", _mrk_name] call BIS_fnc_inString)) then {_sideOfMarker = -1};
			// };
